...
## 节点内核筛选与批量权限组选项（1.15.0，发布准备）

- 待发布版本为 `1.15.0`，功能提交为 `9b1ae3b2a9207ffa29b5946de892c520ce33b159`，包含此前未发布的 `1.14.1` 权限组选项修复；内核筛选的修改基线为 `c7cae437351c9e56d80689356f3e8b222034dfdd`。发布完成后补充固定 Tag、来源提交与镜像核验记录，当前正式版本仍为下节的 `1.14.0`。
...
- 发布前回滚基线为 `ghcr.io/p0me1oo/yzboard:1.14.0-8e360ae`，manifest 为 `sha256:ba4d6204f8b10f9a0f9675bff5299bc8d548ad31898b46f5293a219eda5ae046`；已核对版本别名与 `latest` 一致、两个 Linux 架构可匿名获取，来源均为 `8e360ae81a52ebf1cd4f8d0bd32dd788057f3862`。
