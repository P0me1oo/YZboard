...
window.XBOARD_TRANSLATIONS['en-US'] = {
  ...
  "settings": {
    ...
    "totp": {
      ...
      "description": "Require a time-based code from an authenticator app when signing in to this admin account.",
      "loading": "Loading",
      "statusOn": "Status: enabled",
      "statusOff": "Status: not enabled",
      "recoveryRemaining": "{{count}} recovery codes left",
      "enable": "Enable two-factor authentication",
      "confirm": "Confirm and enable",
      "cancel": "Cancel",
      "disable": "Disable two-factor authentication",
      "regenerate": "Regenerate recovery codes",
      "scanHint": "Scan the QR code with your authenticator app, or enter the key below manually.",
      "qrAlt": "Two-factor authentication QR code",
      "manualKey": "Manual entry key",
      "codeLabel": "Verification code",
      "codePlaceholder": "Enter the 6-digit code or a recovery code",
      "recoveryTitle": "Recovery codes",
      "recoveryHint": "Save these somewhere safe now. They are shown only once and each code works only once.",
