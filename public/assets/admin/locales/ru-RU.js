...
window.XBOARD_TRANSLATIONS['ru-RU'] = {
  ...
  "settings": {
    ...
    "server": {
      ...
      "device_ip_exclude": {
        "title": "IP входных серверов",
        "description": "Указывайте только выходные адреса своих серверов переадресации или входных серверов цепочки прокси. Эти адреса не учитываются как устройства; для TCP-соединений Xray с переданным реальным IP учитывается этот IP.",
        "placeholder": "Один IP или подсеть в строке, например 203.0.113.10 или 203.0.113.0/24",
        "errors": {
          "invalid": "Строка {{line}} не является допустимым IP-адресом или подсетью",
          "too_broad": "Строка {{line}}: слишком широкая подсеть, для IPv4 не менее /16, для IPv6 не менее /48",
          "too_many": "Не более {{max}} записей"
        }
      },
      "saving": "Сохранение..."
    },
    ...
    "totp": {
      ...
      "description": "Требовать одноразовый код из приложения-аутентификатора при входе в эту учётную запись администратора.",
      "loading": "Загрузка",
      "statusOn": "Статус: включена",
      "statusOff": "Статус: не включена",
      "recoveryRemaining": "Осталось кодов восстановления: {{count}}",
      "enable": "Включить двухфакторную аутентификацию",
      "confirm": "Подтвердить и включить",
      "cancel": "Отмена",
      "disable": "Отключить двухфакторную аутентификацию",
      "regenerate": "Создать новые коды восстановления",
      "scanHint": "Отсканируйте QR-код приложением-аутентификатором или введите ключ вручную.",
      "qrAlt": "QR-код двухфакторной аутентификации",
      "manualKey": "Ключ для ручного ввода",
      "codeLabel": "Код подтверждения",
      "codePlaceholder": "Введите 6-значный код или код восстановления",
      "recoveryTitle": "Коды восстановления",
      "recoveryHint": "Сохраните их в надёжном месте. Коды показываются один раз, каждый действует однократно.",
      "copyRecovery": "Скопировать все коды",
      "copied": "Скопировано",
  ...
  "group": {
    ...
    "toolbar": {
      ...
      "reset": "Сбросить",
      "sort": {
        "tip": "Перетаскивайте группы для сортировки, затем нажмите сохранить",
  ...
  "auth": {
    "signIn": {
      ...
      "totp": {
        "title": "Двухфакторная аутентификация",
        "description": "Введите код из приложения-аутентификатора или один из кодов восстановления.",
  ...
  "machine": {
    "agent": {
      ...
      "batch_upgrade": "Обновить выбранные",
      "batch_restart": "Перезапустить выбранные",
      "upgradeConfirm": "Обновить выбранные серверы ({{count}})?",
      "restartConfirm": "Перезапустить выбранные серверы ({{count}})?",
      "interruption": "Узлы yz-agent на этих серверах будут кратковременно прерваны. Обновление до последнего стабильного выпуска.",
      "selectPage": "Выбрать текущую страницу",
      ...
      "results": {
        ...
        "current_newer": "Текущая версия новее; автоматическое понижение отменено"
      },
      "states": {
        "pending": "Ожидание",
        "running": "Выполняется",
      ...
      "errors": {
        ...
        "unsupported": "Удалённые операции недоступны",
        "busy": "Операция уже выполняется",
        "not_found": "Сервер не найден",
        "launch_failed": "Не удалось запустить обработчик",
        "execution_failed": "Ошибка выполнения",
        "release_query_failed": "Не удалось проверить последний стабильный выпуск; обновление остановлено",
        "current_version_failed": "Не удалось прочитать установленную версию; обновление остановлено",
        "current_version_invalid": "Установленная версия не распознана; обновление остановлено",
        "latest_version_invalid": "Последняя стабильная версия не распознана; обновление остановлено",
        "timeout": "Время ожидания истекло; проверьте службу",
        "request_failed": "Отправка не подтверждена; обновите список"
      }
    },
