...
window.XBOARD_TRANSLATIONS['zh-CN'] = {
  ...
  "settings": {
    ...
    "totp": {
      "title": "两步验证",
      "description": "为当前管理员账号启用验证器动态码，登录时需要额外输入一次验证码。",
      "loading": "正在加载",
      "statusOn": "当前状态：已启用",
      "statusOff": "当前状态：未启用",
      "recoveryRemaining": "剩余恢复码 {{count}} 个",
      "enable": "启用两步验证",
      "confirm": "确认启用",
      "cancel": "取消",
      "disable": "关闭两步验证",
      "regenerate": "重新生成恢复码",
      "scanHint": "使用验证器 App 扫描二维码，或手动输入下方密钥。",
      "qrAlt": "两步验证绑定二维码",
      "manualKey": "手动输入密钥",
      "codeLabel": "验证码",
      "codePlaceholder": "请输入 6 位验证码或恢复码",
      "recoveryTitle": "恢复码",
      "recoveryHint": "请立即保存到安全的地方。恢复码只显示这一次，每个仅能使用一次。",
  ...
  "auth": {
    "signIn": {
      ...
      "totp": {
        "title": "两步验证",
        "description": "请输入验证器 App 上的动态验证码，或使用一个恢复码。",
        "code": "验证码",
        "codePlaceholder": "请输入 6 位验证码或恢复码",
        "submit": "验证并登录",
        "back": "返回重新登录",
