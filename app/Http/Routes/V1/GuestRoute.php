...
class GuestRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            // Plan
            $router->get('/plan/fetch', [PlanController::class, 'fetch'])->middleware('throttle:guest-api');
            // Telegram
            ...
            // Comm
            $router->get('/comm/config', [CommController::class, 'config'])->middleware('throttle:guest-api');
        });
    }
}
