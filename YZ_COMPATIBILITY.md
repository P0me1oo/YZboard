...
## 节点内核筛选与批量权限组选项（1.15.0，未发布）

- 开发版本为 `1.15.0`，内核筛选的修改基线为 `c7cae437351c9e56d80689356f3e8b222034dfdd`，包含此前未发布的 `1.14.1` 权限组选项修复；当前正式版本仍为下节的 `1.14.0`，尚未创建本次 Tag、Release 或镜像。
